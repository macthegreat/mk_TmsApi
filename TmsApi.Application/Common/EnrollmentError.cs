...
public sealed record EnrollmentError(string Code, string Message)
{
    ...
    new("course_not_found", $"Course '{code}' was not found."); public static EnrollmentError CourseFull(string title, int capacity)
    =>
    ...
    new("already_enrolled", $"Student {studentId} is already enroll ed in {code}.");
}
