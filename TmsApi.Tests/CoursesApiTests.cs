...
var courses = await response.Content
    .ReadFromJsonAsync<List<CourseRowJson>>();
...
public string Code { get; set; } = ""; public string Title { get; set; } = ""; public int MaxCapacity { get; set; } public int EnrollmentCount { get; set; }
} 
}